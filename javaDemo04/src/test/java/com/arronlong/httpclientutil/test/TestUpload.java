...
public class TestUpload {
	...
	public static void main(String[] args) throws HttpProcessException {
		...
		String url= "http://callBack.free.800m.net:8080/up.php?action=upsave";//上传地址
//		String[] filePaths = {"D:\\中国.txt","D:\\111.txt","C:\\Users\\160049\\Desktop\\中国.png"};//待上传的文件路径
		...
		map.put("path", "./tomcat/vhost/callBack/ROOT/");//指定其他参数
	...
	private static HttpConfig prepareUpload() throws HttpProcessException {
		String url ="http://callBack.free.800m.net:8080/";
